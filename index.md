...
venue: "Earlham Institute"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "24 - 27 January 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10:00 am - 3:00 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2022-01-24      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2022-01-27        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Rob Davey", "Nicola Soranzo", "Jose De Vega", "Felix Shaw", "Alice Minotto"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Odin Moron-Garcia"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/EI_SWC_202201 # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
